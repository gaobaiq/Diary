...
import com.gbq.diary.ui.tools.presenter.impl.RxSchedulersPresenterImpl;
...
/**
 * 类说明：Rx Schedulers 线程调度
 * Author: Kuzan
 * Date: 2017/12/26 10:34.
 */
public class RxSchedulersActivity extends BaseActivity<IRxResultView, RxSchedulersPresenterImpl> implements IRxResultView {
    @Bind(R.id.toolbar)
    BaseBar mToolbar;
    ...
    @Override
    protected RxSchedulersPresenterImpl initPresenter() {
        return new RxSchedulersPresenterImpl();
    }
    ...
    protected void initViewAndData() {
        mToolbar.setTitle(R.string.title_rxschedulers);
        initResultList();
        initEventList();
    }
    ...
    public static void openActivity(Context context) {
        context.startActivity(new Intent(context, RxSchedulersActivity.class));
    }
