...
import com.gbq.diary.ui.tools.presenter.impl.RxDoPresenterImpl;
 ...
 */
public class RxDoActivity extends BaseActivity<IRxResultView, RxDoPresenterImpl> implements IRxResultView {
    @Bind(R.id.toolbar)
    BaseBar mToolbar;
    ...
    @Override
    protected RxDoPresenterImpl initPresenter() {
        return new RxDoPresenterImpl();
    }
    ...
    protected void initViewAndData() {
        mToolbar.setTitle(R.string.title_rxdo);
        initResultList();
        initEventList();
    }
    ...
    public static void openActivity(Context context) {
        context.startActivity(new Intent(context, RxDoActivity.class));
    }
