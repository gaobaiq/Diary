...
import com.gbq.diary.ui.tools.presenter.impl.RxMapPresenterImpl;
 ...
 */
public class RxMapActivity extends BaseActivity<IRxResultView, RxMapPresenterImpl> implements IRxResultView {
    @Bind(R.id.toolbar)
    BaseBar mToolbar;
    ...
    @Override
    protected RxMapPresenterImpl initPresenter() {
        return new RxMapPresenterImpl();
    }
    ...
    public static void openActivity(Context context) {
        context.startActivity(new Intent(context, RxMapActivity.class));
    }
