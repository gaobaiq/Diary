...
import com.gbq.diary.ui.tools.presenter.impl.RxBasePresenterImpl;
 ...
 */
public class RxBaseActivity extends BaseActivity<IRxResultView, RxBasePresenterImpl> implements IRxResultView {
    @Bind(R.id.toolbar)
    BaseBar mToolbar;
    ...
    @Override
    protected RxBasePresenterImpl initPresenter() {
        return new RxBasePresenterImpl();
    }
    ...
    protected void initViewAndData() {
        mToolbar.setTitle(R.string.title_rxbase);
        initResultList();
        initEventList();
    }
    ...
    public static void openActivity(Context context) {
        context.startActivity(new Intent(context, RxBaseActivity.class));
    }
