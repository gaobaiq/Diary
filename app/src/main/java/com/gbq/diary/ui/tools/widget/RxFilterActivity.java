...
import com.gbq.diary.ui.tools.presenter.impl.RxFilterPresenterImpl;
 ...
 */
public class RxFilterActivity extends BaseActivity<IRxResultView, RxFilterPresenterImpl> implements IRxResultView {
    @Bind(R.id.toolbar)
    BaseBar mToolbar;
    ...
    @Override
    protected RxFilterPresenterImpl initPresenter() {
        return new RxFilterPresenterImpl();
    }
    ...
    protected void initViewAndData() {
        mToolbar.setTitle(R.string.title_rxfilter);
        initResultList();
        initEventList();
    }
    ...
    public static void openActivity(Context context) {
        context.startActivity(new Intent(context, RxFilterActivity.class));
    }
