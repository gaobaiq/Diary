...
import com.gbq.diary.ui.tools.presenter.impl.RxTimerPresenterImpl;
 ...
 */
public class RxTimerActivity extends BaseActivity<IRxResultView, RxTimerPresenterImpl> implements IRxResultView {
    @Bind(R.id.toolbar)
    BaseBar mToolbar;
    ...
    @Override
    protected RxTimerPresenterImpl initPresenter() {
        return new RxTimerPresenterImpl();
    }
    ...
    protected void initViewAndData() {
        mToolbar.setTitle(R.string.title_rxtimer);
        initResultList();
        initEventList();
    }
    ...
    public static void openActivity(Context context) {
        context.startActivity(new Intent(context, RxTimerActivity.class));
    }
