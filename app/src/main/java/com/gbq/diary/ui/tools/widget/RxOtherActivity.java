...
import com.gbq.diary.ui.tools.presenter.impl.RxOtherPresenterImpl;
 ...
 */
public class RxOtherActivity extends BaseActivity<IRxResultView, RxOtherPresenterImpl> implements IRxResultView {
    @Bind(R.id.toolbar)
    BaseBar mToolbar;
    ...
    @Override
    protected RxOtherPresenterImpl initPresenter() {
        return new RxOtherPresenterImpl();
    }
    ...
    protected void initViewAndData() {
        mToolbar.setTitle(R.string.title_rxother);
        initResultList();
        initEventList();
    }
    ...
    public static void openActivity(Context context) {
        context.startActivity(new Intent(context, RxOtherActivity.class));
    }
